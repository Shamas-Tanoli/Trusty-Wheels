      ...
      <div class="modal-body">
        ...
        <form id="editPermissionForm" class="row pt-2" onsubmit="return false">
          <div class="col-sm-9">
            ...
            <input type="text" id="editname" name="name" class="form-control" placeholder="city Name" tabindex="-1" />
          </div>
