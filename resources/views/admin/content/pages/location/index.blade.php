...
@section('page-script')
@vite(['resources/assets/admin/js/location.table.js',
'resources/assets/admin/js/location-add.js',
'resources/assets/admin/js/location-edit.js'])
        ...
        <div class="modal-body">
          ...
          <form id="editPermissionForm" class="row pt-2" onsubmit="return false">
            <div class="col-sm-9">
              ...
              <input type="text" id="editname" name="name" class="form-control" placeholder="Location Name" tabindex="-1" />
            </div>
