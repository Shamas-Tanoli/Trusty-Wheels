...
'resources/assets/admin/js/make-add.js',
'resources/assets/admin/js/make-edit.js'])
    ...
    <div class="modal-content">
      <div class="modal-body p-0">
        ...
        <div class="text-center mb-6">
          <h4 class="mb-2">Add New Make</h4>
          {{-- <p>Permissions you may use and assign to your users.</p> --}}
        </div>
        <form id="addPermissionForm" class="row pt-2" onsubmit="return false">
          <div class="col-12 mb-4">
            <label class="form-label" for="modalPermissionName">Make Name</label>
            <input type="text" id="modalPermissionName" name="name" class="form-control" placeholder="Make Name"
              autofocus />
          </div>

          <div class="col-12 text-center demo-vertical-spacing">
            <button type="submit" class=" btn btn-primary me-4">Create Make</button>
