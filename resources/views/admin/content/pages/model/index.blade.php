    ...
    <div class="modal-content">
      <div class="modal-body p-0">
        ...
        <div class="text-center mb-6">
          <h4 class="mb-2">Add New Model</h4>
        ...
        <form id="addPermissionForm" class="row pt-2" onsubmit="return false">
          ...
          <div class="col-12 mb-4">
            <label for="select2Basic" class="form-label">Select Make</label>
            <select name="make_id" id="select2Basic" data-url="{{ route('select.make') }}"
              class="select2  form-select form-select-lg" data-placeholder="Select Make"  data-allow-clear="true">

            </select>
          </div>
          <div class="col-12 mb-4">
            <label class="form-label" for="modalPermissionName">Model Name</label>
            <input type="text" id="modalPermissionName" name="name" class="form-control" placeholder="Model Name"
              autofocus />
          </div>

          <div class="col-12 text-center demo-vertical-spacing">
            <button type="submit" class=" btn btn-primary me-4">Create Model</button>
      ...
      <div class="modal-body">
        ...
        <form id="editPermissionForm" class="row pt-2 justify-content-center" onsubmit="return false">
          ...
          <div class="col-10 mb-4">
            <label for="slectmake" class="form-label">Select Make</label>
            <select name="make_id" id="slectmake" data-url="{{ route('select.make') }}"
              class="select2 form-select form-select-lg" data-allow-clear="true">
            </select>
          </div>

          <div class="col-10 mb-4">
            <label class="form-label" for="editname">Make Name</label>
            <input type="text" id="editname" name="name" class="form-control" placeholder="Make Name" tabindex="-1" />
          </div>
          <div class="col-12 text-center demo-vertical-spacing">
