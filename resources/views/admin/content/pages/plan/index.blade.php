            ...
            <div class="modal-body p-0">
                ...
                <form id="addPermissionForm" class="row pt-2" onsubmit="return false">
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <select name="plan_type" class="select2 form-select form-select-lg">
        ...
        <div class="modal-content p-4">
            ...
            <form id="editPlanForm" class="row" onsubmit="return false">
                ...
                <div class="col-12 mb-3">
                    ...
                    <select id="edit_area_from" data-placeholder="Select  Destination  Area" data-allow-clear="true"
                        data-url="{{ route('select.towns') }}" name="area_from_id" class="select2 form-select"></select>
                </div>

                <div class="col-12 mb-3">
                    <label>Area To</label>
                    <select id="edit_area_to" data-placeholder="Select  Destination  Area" data-allow-clear="true"
                        data-url="{{ route('select.towns') }}" name="area_to_id" class="select2 form-select"></select>
                </div>
                ...
                <div class="col-12 mb-4">
                    ...
                    <select id="edit_plan_type" name="plan_type" class="form-select">
