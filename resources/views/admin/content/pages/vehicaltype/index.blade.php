...
@section('page-script')
@vite([
'resources/assets/admin/js/vehical-type.js'])
        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                ...
                <div class="text-center mb-6">
                    <h4 class="mb-2">Add  Vehical Type</h4>
                    {{-- <p>Permissions you may use and assign to your users.</p> --}}
                </div>
                <form id="addPermissionForm" class="row pt-2" onsubmit="return false">
                    <div class="col-12 mb-4">
                        <label class="form-label" for="modalPermissionName">Vehical Type </label>
                        <input type="text" id="modalPermissionName" name="name" class="form-control"
                            placeholder="Vehical Type" autofocus />
                    </div>

                    <div class="col-12 text-center demo-vertical-spacing">
                        <button type="submit" class=" btn btn-primary me-4">Create Vehical Type</button>
    ...
    <div class="modal-dialog modal-dialog-centered modal-simple">
        <div class="modal-content">
            <div class="modal-body">
                <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="text-center mb-6">
                    <h4 class="mb-2">Edit Location</h4>
                    {{-- <p>Edit permission as per your requirements.</p> --}}
                </div>

                <form id="editPermissionForm" class="row pt-2" onsubmit="return false">
                    <div class="col-sm-9">
                        <label class="form-label" for="editname">Location Name</label>
                        <input type="text" id="editname" name="name" class="form-control" placeholder="Location Name"
                            tabindex="-1" />
                    </div>
